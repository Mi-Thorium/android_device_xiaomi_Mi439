...
ifeq ($(PRODUCT_USE_DYNAMIC_PARTITIONS),true)
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/rootdir/etc/recovery_dynpart.fstab
else
...
SOONG_CONFIG_XIAOMI_MI439_ROOTDIR := USE_DYNAMIC_PARTITIONS
SOONG_CONFIG_XIAOMI_MI439_ROOTDIR_USE_DYNAMIC_PARTITIONS := $(PRODUCT_USE_DYNAMIC_PARTITIONS)
