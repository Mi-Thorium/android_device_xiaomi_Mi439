...
# Kernel - Prebuilt
ifeq ($(TARGET_KERNEL_VERSION),4.19)
PRODUCT_COPY_FILES += device/xiaomi/kernel-mithorium/Mi439_4_19/Image.gz-dtb:kernel
else
PRODUCT_COPY_FILES += device/xiaomi/kernel-mithorium/Mi439/Image.gz-dtb:kernel
endif
